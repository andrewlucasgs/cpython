...
enum _stmt_kind {FunctionDef_kind=1, AsyncFunctionDef_kind=2, ClassDef_kind=3,
                  ...
                  AsyncWith_kind=14, Pipe_kind=15, Raise_kind=16, Try_kind=17,
...
stmt_ty _Py_AsyncWith(asdl_seq * items, asdl_seq * body, string type_comment,
                      ...
                      end_col_offset, PyArena *arena);
#define Pipe(a0, a1, a2, a3, a4, a5, a6) _Py_Pipe(a0, a1, a2, a3, a4, a5, a6)
stmt_ty _Py_Pipe(expr_ty args, expr_ty func, int lineno, int col_offset, int
                 end_lineno, int end_col_offset, PyArena *arena);
